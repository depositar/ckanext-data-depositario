...
更新內容：
 * 更新：CKAN 核心至 `2.10.11 <https://docs.ckan.org/en/2.10/changelog.html#v-2-10-11-2026-08-26>`_。
 * 改善：手機介面優先顯示中欄資訊。
 * 改善：於註冊頁面提示使用者名稱規定。
 * 改善：部分文案修正。
...
更新內容：
 * 改善：修復因 Markdown 欄位文句截短，導致頁面顯示異常的問題。
 * 改善：限制未隸屬於任何專案的資料集，僅能由上傳者本人或協作者編輯。
 * 改善：手冊中文搜尋。
 * 改善：部分文案修正。
...
更新內容：
 * 更新：CKAN 核心至 `2.10.9 <https://docs.ckan.org/en/2.10/changelog.html#v-2-10-9-2025-10-29>`_。
 * 改善：隱藏主題與專案客製化欄位。
 * 改善：修復儀表板/我的專案頁面的連結與按鈕文字。
 * 改善：部分文案修正。
...
更新內容：
 * 更新：CKAN 核心至 `2.10.8 <https://docs.ckan.org/en/2.10/changelog.html#v-2-10-8-2025-05-07>`_。
